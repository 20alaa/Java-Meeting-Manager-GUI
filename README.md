Meeting Manager Desktop Application

Project Overview:
Java Swing application designed to help users schedule and manage meetings through a Graphical User Interface (GUI).

Technical:
GUI Development: Built using the `javax.swing` and `java.awt` libraries, featuring a structured layout with `GridLayout`, `BorderLayout`, and `FlowLayout`.
